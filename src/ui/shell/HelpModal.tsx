...
const TOPICS: Topic[] = [
  {
    ...
    lines: [
      ...
      '准则 1:1 点落在中心线任一侧 3σ 之外(Nelson 1984 / Minitab 检验 1)。',
      '准则 2:连续 9 点落在中心线同一侧(Minitab 检验 2)。',
      '准则 3:连续 6 点持续上升或持续下降(Minitab 检验 3)。',
      '准则 4:相邻 3 点中有 2 点落在同侧 2σ 区之外(Minitab 检验 5)。',
